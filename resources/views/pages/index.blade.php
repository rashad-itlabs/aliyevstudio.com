...
@section('title', 'AliyevStudio | Peşəkar Veb Dizayn, Mobil Tətbiqlər və Flutter Kursları')
@section('description', 'Biznesinizi rəqəmsal dünya ilə bir araya gətiririk. Veb saytların yığılması, mobil tətbiqlərin hazırlanması, UI/UX dizayn və sıfırdan peşəkar Flutter kursları.')
...
@section('content')
        ...
        <div id="smooth-content">
            <section class="hero-section-3">
                ...
                <div class="container">
                    ...
                    <h1 class="title mb-0 anim-text">Peşəkar</h1>
                        <h1 class="title anim-text">
                            <br>
                        Flutt<span>e</span>r
                        Kursları
                        </h1>
                    <p>Tək bir kod bazası ilə iOS, Android və Veb üçün mükəmməl, sürətli və nativ keyfiyyətli tətbiqlər yaradın. Flutter kurslarımıza qoşulun və proqramlaşdırma bacarıqlarınızı inkişaf etdirin.</p>
                    <a href="{{ route('courses') }}" class="rr-primary-btn">
                        Kurslara Qoşul<i class="fa-thin fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            </section>
                            ...
                            <div class="about-content-4 fade-wrapper">
                                <div class="section-heading heading-3 mb-0">
                                    <h4 class="sub-heading after-none" data-text-animation="fade-in"
                                        data-duration="1.5">Şirkətimiz Haqqında</h4>
                                    <h2 class="section-title t-up" data-text-animation data-split="word"
                                        data-duration="1">Bİznesİnİzİ rəqəmsal dünya İlə bİr araya gətİrİrİk</h2>
                                    <p class="fade-top">Bİzİ rəqİblərİmİzdən fərqləndİrən və peşəkar rəqəmsal xİdmətlər təqdİm etməyİmİzə İmkan yaradan əsas amİl budur. İllərİn təcrübəsİnə əsaslanaraq öyrəndİk kİ, hər bİr rəqəmsal kanalın öz üstünlüklərİ olsa da, onlar vahİd bİr strategİyada bİrləşdİrİldİkdə ən mükəmməl nətİcənİ verİr.
                                    </p>
                                </div>
                                ...
                                <div class="about-btn fade-top">
                                    <a href="{{route('about')}}" class="rr-primary-btn">
                                        İndi Başla <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="service-left sticky-widget">
                                <div class="section-heading heading-3">
                                    <h4 class="sub-heading after-none" data-text-animation="fade-in"
                                        data-duration="1.5">Təklİf Etdİyİmİz Xİdmətlər</h4>
                                    <h2 class="section-title" data-text-animation data-split="word" data-duration="1">
                                        Möhtəşəm rəqəmsal həllər təqdİm edİrİk</h2>
                                    <a href="{{route('services')}}" class="rr-primary-btn">
                                        Bütün Xİdmətlər <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12">
                            <div class="service-box-wrap fade-top">
                                <div class="service-box">
                                    ...
                                    <div class="icon">
                                        <svg width="61" height="61" viewBox="0 0 61 61" fill="currentColor"
                                    ...
                                    <h3 class="title">
                                        <a href="{{route('service-detail','veb-programlasdirma')}}">Veb Proqramlaşdırma</a>
                                    </h3>
                                    <div class="service-img">
                                        <img src="assets/img/service/src-1.jpeg" alt="service">
                                    </div>
                                </div>
                                <div class="service-box">
                                    <span class="number">02</span>
                                    <div class="icon">
                                        <svg width="65" height="54" viewBox="0 0 65 54" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <h3 class="title">
                                        <a href="{{route('service-detail','mobile-app')}}">Mobil Tətbiqlər</a>
                                    </h3>
                                    <div class="service-img">
                                        <img src="assets/img/service/src-2.jpeg" alt="service">
                                    </div>
                                </div>
                                <div class="service-box">
                                    ...
                                    <h3 class="title">
                                        <a href="{{route('service-detail','design-brending')}}">Dizayn və Brendinq</a>
                                    </h3>
                                    <div class="service-img">
                                        <img src="assets/img/service/src-3.jpeg" alt="service">
                                    </div>
                                </div>
                                <div class="service-box">
                                    ...
                                    <h3 class="title">
                                        <a href="{{route('service-detail','app-programlasdirma')}}">Tətbiq Proqramlaşdırması</a>
                                    </h3>
                                    <div class="service-img">
                                        <img src="assets/img/service/src-4.jpeg" alt="service">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="process-section-3 pt-130 pb-130" data-background="assets/img/bg-img/process-bg.png">
                <div class="container">
                    <div class="section-heading heading-3 text-center">
                        ...
                        <h2 class="section-title" data-text-animation data-split="word" data-duration="1">4 Sadə Addımda
                            İş Prosesi</h2>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="process-item-wrap fade-top">
                                <div class="process-item-2 text-center">
                                    ...
                                    <span>Addım 1</span>
                                    <h3 class="title">Layihənin Araşdırılması</h3>
                                    <div class="process-bottom">
                                        <p>Bu mərhələ detallı analiz və rəqəmsal həllərin planlaşdırılmasını əhatə edir.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="process-item-wrap fade-top">
                                <div class="process-item-2 text-center">
                                    ...
                                    <span>Addım 2</span>
                                    <h3 class="title">İşə Başlama</h3>
                                    <div class="process-bottom">
                                        <p>Müasir texnologiyalar və innovativ metodlarla kodlaşdırma prosesinə başlayırıq.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="process-item-wrap fade-top">
                                <div class="process-item-2 text-center">
                                    ...
                                    <span>Addım 3</span>
                                    <h3 class="title">Keyfiyyət Kontrolu</h3>
                                    <div class="process-bottom">
                                        <p>Layihə tamamlanmadan əvvəl dəqiq testlər və optimallaşdırma həyata keçirilir.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="process-item-wrap fade-top">
                                <div class="process-item-2 text-center">
                                    ...
                                    <span>Addım 4</span>
                                    <h3 class="title">Layihənin Təhvili</h3>
                                    <div class="process-bottom">
                                        <p>Tam hazır və işlək vəziyyətdə olan layihə müştəriyə uğurla təhvil verilir.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="running-text running-3">
                ...
                <div class="carouselTicker carouselTicker-nav" data-speed="fast">
                    <ul class="text-anim carouselTicker__list scroller__inner inner-3">
                        <li>Son Layihələr</li>
                        <li class="stroke-text">Veb Proqramlaşdırma</li>
                        <li>Son Layihələr</li>
                        <li class="stroke-text">Veb Proqramlaşdırma</li>
                        <li>Son Layihələr</li>
                        <li class="stroke-text">Veb Proqramlaşdırma</li>
            ...
            <section class="blog-section-3 pb-130 fade-wrapper">
                <div class="shapes">
                    <div class="shape shape-1">
                        <img src="assets/img/shapes/blog-round-shape-1.png" alt="shape">
                    </div>
                    <div class="shape shape-2">
                        <img src="assets/img/shapes/blog-round-shape-2.png" alt="shape">
                    </div>
                </div>
                <div class="container">
                    <div class="section-heading text-center">
                        <h4 class="sub-heading" data-text-animation="fade-in" data-duration="1.5">XƏBƏRLƏR VƏ YENİLİKLƏR
                        </h4>
                        <h2 class="section-title" data-text-animation data-split="word" data-duration="1">Şirkətimizin Ən Son
                            Yenilikləri İlə Tanış Olun</h2>
                    </div>
                            ...
                            <div class="post-card-2 card-3 fade-top">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title">
                                            <a href="">Veb Dizayn Agentliyimizlə İstifadəçi Təcrübəsini 
                                                Yenidən Kəşf Edin...</a>
                                        </h3>
                                        <a href="" class="rr-primary-btn">
                                            Daha Ətraflı <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="post-card-2 card-3 fade-top">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title">
                                            <a href="">Hər Veb Dizayn Layihəsində İstifadəçi 
                                                Təcrübəsi Niyə Önəmlidir?</a>
                                        </h3>
                                        <a href="" class="rr-primary-btn">
                                            Daha Ətraflı <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </a>
                            ...
                            <div class="post-card-2 card-3 fade-top">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title">
                                            <a href="">Veb Dizayn Agentliyimizin Uğur
                                                Sirlərini Kəşf Edin</a>
                                        </h3>
                                        <a href="" class="rr-primary-btn">
                                            Daha Ətraflı <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </a>
            ...
            <footer class="footer-section footer-2 footer-3 bg-dark-1 overflow-hidden">
                ...
                <div class="container">
                    <div class="footer-top">
                        <h2 class="title" data-text-animation data-split="word" data-duration="1">
                            Xəyalınızdakı Növbətİ Layİhəyə <br>Bİrlİkdə Başlayaq
                        </h2>
                        <a href="{{route('contact')}}" class="footer-btn">
    ...
    <!-- Flutter Course Popup Modal -->
    <div id="course-popup-modal" class="course-popup-modal">
        <div class="course-popup-content">
            <button class="close-popup-btn" aria-label="Bağla"><i class="fa-regular fa-xmark"></i></button>
            <div class="popup-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45" height="45"><path fill="#54C5F8" d="M14.314 0L2.3 12l4.6 4.6 12.014-12zM21.5 19.1l-4.6-4.6-4.6 4.6 4.6 4.6zM12.3 14.6l-2.3-2.3-4.6 4.6 4.6 4.6z"/></svg>
            </div>
            <h3>Flutter Kurslarına Qeydiyyat Başladı!</h3>
            <p>Gələcəyin peşəsinə yiyələnmək üçün fürsəti qaçırmayın. 0-dan peşəkar səviyyəyə qədər praktiki Flutter təlimlərimizə indi qoşulun.</p>
            <a href="{{ route('courses') }}" class="rr-primary-btn popup-btn">Kursa Qoşul <i class="fa-regular fa-arrow-right"></i></a>
        </div>
    </div>
    ...
    <style>
        ...
        .course-popup-modal.show .course-popup-content {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Səhifə yükləndikdən 3 saniyə sonra
            setTimeout(function() {
                const popup = document.getElementById('course-popup-modal');
                if (popup) {
                    popup.classList.add('show');
                }
            }, 3000);

            // Bağlamaq üçün klik hadisələri
            const closeBtn = document.querySelector('.close-popup-btn');
            const popupModal = document.getElementById('course-popup-modal');
            ...
            // Kənara vuranda pəncərəni bağlamaq
            if (popupModal) {
